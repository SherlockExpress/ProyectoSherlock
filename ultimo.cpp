...
public:
    ...
    vector<Pedido> getHistorialPedidos() const { return historialPedidos; }
};
...
int main() {
    ...
    catalogo[8] = Producto(8, "Marihuana", 30.10);
    catalogo[9] = Producto(9, "Cocaina", 55.25);
    catalogo[10] = Producto(10, "Chaer", 100.01);
